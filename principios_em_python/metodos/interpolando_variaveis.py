...
pessoa = {'nome': "Dany", 'idade': 19,'profissao': "Programadora",'linguagem': "Python" }
...
# metodo format
print("Olá me chamo {}. Eu tenho {} anos de idade, trabalho como {} e estou matriculada no curso de {}."
       .format(nome, idade, profissao, linguagem))
# pode usar nomeando a ordem de cada variavel
print("Olá me chamo {3}. Eu tenho {1} anos de idade, trabalho como {2} e estou matriculada no curso de {0}."
       .format(linguagem, idade, profissao, nome))
# passando variavel
print("Olá me chamo {nome}. Eu tenho {idade} anos de idade, trabalho como {profissao} e estou matriculada no curso de {linguagem}."
