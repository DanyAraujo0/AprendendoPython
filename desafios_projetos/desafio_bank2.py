...
def criar_conta(usuarios,numero_conta,AGENCIA,contas):
    ...
    usuario = filtrar_usuario(cpf,usuarios)
    if usuario:
        contas.append({"cpf": cpf, "agencia": AGENCIA, "numero_conta": numero_conta, "usuario": usuario}) 
...
def main():
    ...
    while True:
        ...
        if opcao == "d":
            ...
            sacar(saldo = saldo, LIMITE_SAQUES = LIMITE_SAQUES, numero_saques = numero_saques, extrato = extrato, limite=limite)
        elif opcao == "e":
